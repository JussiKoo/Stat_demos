...
```{r tulojen_jakauma, fig.cap="Tulojen jakauma ja gamma-jakauma", fig.height=2.5, fig.width=4}
ggplot(data=d, mapping=aes(tulot))+
  geom_density()+
  stat_function(fun = dgamma, args = list(shape = 4.5, rate = 4.5/24000), color = "blue", linewidth = 1)
```

Kuvasta \@ref(fig:tulojen_jakauma) käy ilmi, että tulojen voitaisiin ajatella noudattavan gamma-jakaumaa.

```{r arvosana_tulo_yhteys, fig.cap="Koulukeskiarvon yhteys tuloihin"}
