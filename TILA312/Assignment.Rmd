...
Hurdle-model consists of two components. One component for positive counts such as Poisson model and one hurdle component to account the excess zero-counts. The hurdle models probability density function is
...
xyplot(count ~ cover|spp, data=salam)
