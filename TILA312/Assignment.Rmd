...
#Center age to mean age
data$c_age <- data$age - mean(data$age)

attach(data)


#Compute ratio of deaths vs cases for each age. Ages are rounded.
dratioage <- aggregate(death, by=list(round(age)), FUN=mean)

plot(dratioage$x ~ dratioage$Group.1, ylab="Probability of dying", xlab="Age")
```
