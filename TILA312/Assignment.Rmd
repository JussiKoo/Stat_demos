...
For the interpretations here the hurdle component basically gives the probability to encounter any lizards. The count component models the positive counts of lizards.

Let's make some interpretations first from regular model.
