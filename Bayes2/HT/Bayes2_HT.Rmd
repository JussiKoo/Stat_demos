...
```{r}
kuva1 <- ggplot(data=mobile, mapping=aes(x=sex, y=ict_mean))+
  geom_boxplot()

kuva2 <- ggplot(data=mobile, mapping=aes(x=age, y=ict_mean, colour = sex))+
  geom_boxplot()

ggplot(data=mobile, mapping=aes(x=income, y=ict_mean))+
  geom_boxplot()

ggplot(data=mobile, mapping=aes(x=brand_prev, y=ict_mean))+
  geom_boxplot()
